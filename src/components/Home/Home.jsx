...
<dialog id="my_modal_2" className="modal modal-bottom sm:modal-middle">
  ...
  <h3 className="font-bold text-lg text-[#000000]">All Kinds Of Immigration Services</h3>
    ...
    <div className="modal-action">
      ...
      {/* Services Card */}
      {/* Student visa */}
      <h1 className="text-center text-4xl font-bold mb-4">Students Favorite Top Countries for Higher Education</h1>
  ...
  <div className="card-body">
    ...
    <div className="card-actions">
      ...
      {/* Tourist visa */}
      <h1 className="text-center text-4xl font-bold mb-4">Top Favorite  Countries for Tourist</h1>

      <div>
      <div className="card card-compact w-96 bg-base-100 shadow-xl">
  <figure><img src="https://img.freepik.com/free-photo/collage-travelling-made-with-chalk_23-2150722108.jpg?w=900&t=st=1705764429~exp=1705765029~hmac=aaa93ad71d1c9d980b1f51705a99e53ecac6741178142645e9c5a23f408792df" alt="Shoes" /></figure>
  <div className="card-body">
    <h2 className="card-title">Travel To Europe</h2>
    <p>If a dog chews shoes whose shoes does he choose?</p>
    <div className="card-actions">
      <button className="btn btn-primary">Learn More</button>
    </div>
      ...
      {/* Work visa */}
      <h1 className="text-center text-4xl font-bold mb-4">Top  Countries for Work</h1>

      <div>
      <div className="card card-compact w-96 bg-base-100 shadow-xl">
  <figure><img src="https://img.freepik.com/free-photo/civil-engineer-construction-worker-architects-wearing-hardhats-safety-vests-are-working-together-construction-site-building-home-cooperation-teamwork-concept_640221-172.jpg?w=826&t=st=1705764665~exp=1705765265~hmac=02a13c533e3f667927db459b238df90167e6ae8bfc48caf2a0ad0c2df5199cec" alt="Shoes" /></figure>
  <div className="card-body">
    <h2 className="card-title">Work To Europe</h2>
    <p>If a dog chews shoes whose shoes does he choose?</p>
    <div className="card-actions">
      <button className="btn btn-primary">Learn More</button>
    </div>
